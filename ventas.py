...
# Datos de ejemplo
ventas = [
    ('2022-06-29', 'Computador Gamer i5', 'Tecnología', 990000, 3, 990000*3),
    ('2024-04-18', 'Televisor 50" 4K', 'Tecnología', 1500000, 2, 1500000*2),
    ('2023-12-15', 'Celular Samsung Galaxy S21', 'Tecnología', 1200000, 5, 1200000*5),
    ('2024-02-23', 'Tablet iPad Air', 'Tecnología', 2000000, 2, 2000000*2),
    ('2021-01-13', 'Laptop Dell XPS 13', 'Tecnología', 2500000, 2, 2500000*2),
    ...
    ('2022-04-18', 'Smartwatch Apple Watch Series 7', 'Tecnología', 1300000, 3, 1300000*3),
    ('2023-06-06', 'Zapatillas Deportivas Nike', 'Ropa', 300000, 2, 600000),
    ('2023-06-09', 'Camiseta Adidas', 'Ropa', 80000, 3, 240000),
    ('2023-03-27', 'Pantalón Levi\'s', 'Ropa', 150000, 5, 150000*5),
    ...
    ('2022-03-23', 'Licuadora Foster', 'Cocina', 250000, 2, 250000*2),
    ('2022-10-13', 'Microondas Samsung', 'Cocina', 450000, 3, 450000*3),
    ('2023-03-24', 'Horno Eléctrico', 'Cocina', 300000, 5, 300000*5),
    ('2024-03-25', 'Cafetera Expressp', 'Cocina', 350000, 1, 350000),
